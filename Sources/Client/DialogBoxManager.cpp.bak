...
void DialogBoxManager::InitDefaults()
{
	...
	// Upgrade Window
	m_info[DialogBoxId::UpgradeWindow].sX = 380;
	m_info[DialogBoxId::UpgradeWindow].sY = 180;
	m_info[DialogBoxId::UpgradeWindow].sSizeX = 160;
	m_info[DialogBoxId::UpgradeWindow].sSizeY = 85;

	// Upgrade all
	m_info[DialogBoxId::UpgradeAll].sX = 185;
	m_info[DialogBoxId::UpgradeAll].sY = 100;
	m_info[DialogBoxId::UpgradeAll].sSizeX = 350;
	m_info[DialogBoxId::UpgradeAll].sSizeY = 105;
